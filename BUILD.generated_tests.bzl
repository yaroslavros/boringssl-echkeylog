...
crypto_test_sources = [
    ...
    "src/crypto/bn_extra/bn_test.cc",
    "src/crypto/buf/buf_test.cc",
    "src/crypto/bytestring/bytestring_test.cc",
    "src/crypto/chacha/chacha_test.cc",
    "src/crypto/cipher_extra/aead_test.cc",
    "src/crypto/cipher_extra/aes_test.cc",
    "src/crypto/cipher_extra/cipher_test.cc",
    "src/crypto/cipher_extra/cmac_test.cc",
    "src/crypto/cipher_extra/gcm_test.cc",
    "src/crypto/cipher_extra/hkdf_test.cc",
    "src/crypto/cipher_extra/md5_test.cc",
    "src/crypto/cipher_extra/sha_test.cc",
    ...
    "src/crypto/ec_extra/ec_test.cc",
    "src/crypto/ec_extra/p256-nistz_test.cc",
    "src/crypto/ec_extra/p256_test.cc",
    "src/crypto/ecdh_extra/ecdh_test.cc",
    "src/crypto/ecdsa_extra/ecdsa_test.cc",
    ...
    "src/crypto/rand_extra/ctrdrbg_test.cc",
...
crypto_test_data = [
    ...
    "src/crypto/bn_extra/test/exp_tests.txt",
    "src/crypto/bn_extra/test/gcd_tests.txt",
    "src/crypto/bn_extra/test/miller_rabin_tests.txt",
    "src/crypto/bn_extra/test/mod_exp_tests.txt",
    "src/crypto/bn_extra/test/mod_inv_tests.txt",
    "src/crypto/bn_extra/test/mod_mul_tests.txt",
    "src/crypto/bn_extra/test/mod_sqrt_tests.txt",
    "src/crypto/bn_extra/test/product_tests.txt",
    "src/crypto/bn_extra/test/quotient_tests.txt",
    "src/crypto/bn_extra/test/shift_tests.txt",
    "src/crypto/bn_extra/test/sum_tests.txt",
    "src/crypto/cipher_extra/aes_tests.txt",
    "src/crypto/cipher_extra/cavp_3des_cmac_tests.txt",
    "src/crypto/cipher_extra/cavp_aes128_cmac_tests.txt",
    "src/crypto/cipher_extra/cavp_aes192_cmac_tests.txt",
    "src/crypto/cipher_extra/cavp_aes256_cmac_tests.txt",
    "src/crypto/cipher_extra/gcm_tests.txt",
    ...
    "src/crypto/ec_extra/ec_scalar_base_mult_tests.txt",
    "src/crypto/ec_extra/p256-nistz_tests.txt",
    "src/crypto/ecdh_extra/ecdh_tests.txt",
    "src/crypto/ecdsa_extra/ecdsa_sign_tests.txt",
    "src/crypto/ecdsa_extra/ecdsa_verify_tests.txt",
    ...
    "src/crypto/rand_extra/ctrdrbg_vectors.txt",
